...
export default async function AdminDashboardPage() {
  ...
  const [totalMembers, totalDonations, pendingDonations, totalPosts, totalEvents, pendingReports] =
    await Promise.all([
      prisma.user.count(),
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-8 gap-6">
        ...
        <Link href="/dashboard/admin/kyc" className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-500/30 transition">
          ...
          <p className="text-sm text-gray-400 mt-2">Validation des documents</p>
        </Link>
