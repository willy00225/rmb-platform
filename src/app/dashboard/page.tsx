    ...
    <div className="space-y-6 animate-fadeInUp">
      ...
      <div className="rounded-[var(--radius-card)] bg-white dark:bg-surface border border-border shadow-[var(--shadow-card)] p-6">
        <textarea
          ...
          rows={3}
          className="w-full resize-none rounded-xl bg-gray-50 dark:bg-white/5 border border-border px-4 py-3 text-text placeholder-text-secondary focus:outline-none focus:border-primary transition"
        />
